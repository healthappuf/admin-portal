...
import { Home, PersonAdd, Settings, List, People } from '@mui/icons-material';
    ...
    return (
        <div className="divide-y-2 divide-gray-400 w-72 text-white bg-menu fixed h-full">
            ...
            <ul className=" p-4 pt-10">
                ...
                <MenuItem active={props.selectedOption === "Patients"} icon={People} name="Patients" setActive={props.setSelectedOption} />
